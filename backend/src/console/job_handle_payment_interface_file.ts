...
export default async function main() {
  ...
  // const fileContent_event: string = await readFileSync("./dist/cems_event.csv", "utf8")
  // const fileContent_item: string = await readFileSync("./dist/cems_item.csv", "utf8")
  const fileContent_event = await readFile("./src/console/cems_event.csv", { encoding: 'utf8' })
  const fileContent_item = await readFile("./src/console/cems_item.csv", { encoding: 'utf8' })
